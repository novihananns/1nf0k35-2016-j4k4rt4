...
$data_tabel[] = array(
	...
	'lama_kb'			=> (isset($kb[$id]['berencana_II_5_tahun']) && $kb[$id]['berencana_II_5_tahun']!=""? $kb[$id]['berencana_II_5_tahun'].' Tahun' : "").' '.(isset($kb[$id]['berencana_II_5_bulan']) && $kb[$id]['berencana_II_5_bulan']!=""? $kb[$id]['berencana_II_5_bulan'].' Bulan' : "").' '.(((!isset($kb[$id]['berencana_II_5_tahun'])) && (!isset($kb[$id]['berencana_II_5_bulan'])) ) ? '-' : ""),
