...
$data_tabel[] = array(
	...
	'sumber_pendapatan'		=> (isset($profile[$id]['profile_c_2_a_radio']) && $profile[$id]['profile_c_2_a_radio']==1? "Pekerjaan;" : "").' '.(isset($profile[$id]['profile_c_2_b_radio']) && $profile[$id]['profile_c_2_b_radio']==1? "Sumbangan;" : "").' '.(isset($profile[$id]['profile_c_2_c_radio']) && $profile[$id]['profile_c_2_c_radio']==1? "Lainnya" : "").' '.((!isset($profile[$id]['profile_c_2_a_radio']) &&!isset($profile[$id]['profile_c_2_b_radio']) && !isset($profile[$id]['profile_c_2_c_radio'])) ? 'Tidak' :''),
	...
	'pendidikan'	=> ((isset($anggota[$id][$no_anggota]['id_pilihan_pendidikan'])) ? ($anggota[$id][$no_anggota]['id_pilihan_pendidikan']== 14 ? "Tidak Tamat SD/MI" : ($anggota[$id][$no_anggota]['id_pilihan_pendidikan']==15? "Masih SD/MI" : ($anggota[$id][$no_anggota]['id_pilihan_pendidikan']==16? "Tamat SD/MI" : ($anggota[$id][$no_anggota]['id_pilihan_pendidikan']==17? "Masih SLTP/MTs" : ($anggota[$id][$no_anggota]['id_pilihan_pendidikan']==18? "Tamat SLTP/MTs" : ($anggota[$id][$no_anggota]['id_pilihan_pendidikan']==19? "Masih SLTA/MA" : ($anggota[$id][$no_anggota]['id_pilihan_pendidikan']==20? "Tamat SLTA/MA" : ($anggota[$id][$no_anggota]['id_pilihan_pendidikan']==21? "Masih PT/Akademi" : ($anggota[$id][$no_anggota]['id_pilihan_pendidikan']==22? "Tamat PT/Akademi" : ($anggota[$id][$no_anggota]['id_pilihan_pendidikan']==23? "Tidak/Belum Sekolah" : "Tidak")))))))))):'Tidak'),
	...
	'kb_suami'			=> isset($kb[$id]['berencana_II_1_suami']) && $kb[$id]['berencana_II_1_suami']!=""? $kb[$id]['berencana_II_1_suami'] : "Tidak",
	'kb_istri'			=> isset($kb[$id]['berencana_II_1_istri']) && $kb[$id]['berencana_II_1_istri']!=""? $kb[$id]['berencana_II_1_istri'] : "Tidak",
	...
	'kb_hidup_l'		=> isset($kb[$id]['berencana_II_2_laki_hidup']) && $kb[$id]['berencana_II_2_laki_hidup']!=""? $kb[$id]['berencana_II_2_laki_hidup'] : "Tidak",
	'kb_hidup_p'		=> isset($kb[$id]['berencana_II_2_perempuan_hidup']) && $kb[$id]['berencana_II_2_perempuan_hidup']!=""? $kb[$id]['berencana_II_2_perempuan_hidup'] : "Tidak",
	...
	'kes_sakit_gigi_tidak'	=> !isset($anggota_pr[$id][$no_anggota]['kesehatan_1_g_3_f_cebox']) || $anggota_pr[$id][$no_anggota]['kesehatan_1_g_3_f_cebox']!=1? "Tidak" : "Ya",
	...
	'kes_rokok_setiap'	=> isset($anggota_pr[$id][$no_anggota]['kesehatan_1_g_2_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_1_g_2_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_1_g_2_text'] : "Tidak",
	'kes_rokok_pertama'	=> isset($anggota_pr[$id][$no_anggota]['kesehatan_1_g_3_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_1_g_3_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_1_g_3_text'] : "Tidak",
	...
	'kanker_thn'				=> isset($anggota_pr[$id][$no_anggota]['kesehatan_3_g_2_kk_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_3_g_2_kk_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_3_g_2_kk_text'] : "Tidak",
	...
	'kesehatan_4_g_2_hp_text'	=> isset($anggota_pr[$id][$no_anggota]['kesehatan_4_g_2_hp_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_4_g_2_hp_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_4_g_2_hp_text'] : "Tidak",
	...
	'kesehatan_4_g_2_jk_text'	=> isset($anggota_pr[$id][$no_anggota]['kesehatan_4_g_2_jk_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_4_g_2_jk_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_4_g_2_jk_text'] : "Tidak",
	...
	'kesehatan_4_g_2_sk_text'	=> isset($anggota_pr[$id][$no_anggota]['kesehatan_4_g_2_sk_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_4_g_2_sk_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_4_g_2_sk_text'] : "Tidak",
	...
	'kesehatan_6_g_2_ol_text'	=> isset($anggota_pr[$id][$no_anggota]['kesehatan_6_g_2_ol_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_6_g_2_ol_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_6_g_2_ol_text'] : "Tidak",
	'kesehatan_6_g_2_td_text'	=> isset($anggota_pr[$id][$no_anggota]['kesehatan_6_g_2_td_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_6_g_2_td_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_6_g_2_td_text'] : "Tidak",
	'kesehatan_6_g_3_td_text'	=> isset($anggota_pr[$id][$no_anggota]['kesehatan_6_g_3_td_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_6_g_3_td_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_6_g_3_td_text'] : "Tidak",
	'kesehatan_6_g_3_tn_text'	=> isset($anggota_pr[$id][$no_anggota]['kesehatan_6_g_3_tn_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_6_g_3_tn_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_6_g_3_tn_text'] : "Tidak",
	'kesehatan_6_g_3_p_text'	=> isset($anggota_pr[$id][$no_anggota]['kesehatan_6_g_3_p_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_6_g_3_p_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_6_g_3_p_text'] : "Tidak",
	'kesehatan_6_g_3_s_text'	=> isset($anggota_pr[$id][$no_anggota]['kesehatan_6_g_3_s_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_6_g_3_s_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_6_g_3_s_text'] : "Tidak",
	'kesehatan_6_g_4_at_text'	=> isset($anggota_pr[$id][$no_anggota]['kesehatan_6_g_4_at_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_6_g_4_at_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_6_g_4_at_text'] : "Tidak",
	'kesehatan_6_g_4_bb_text'	=> isset($anggota_pr[$id][$no_anggota]['kesehatan_6_g_4_bb_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_6_g_4_bb_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_6_g_4_bb_text'] : "Tidak",
	'kesehatan_6_g_4_sg_text'	=> isset($anggota_pr[$id][$no_anggota]['kesehatan_6_g_4_sg_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_6_g_4_sg_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_6_g_4_sg_text'] : "Tidak",
	...
	'kesehatan_6_g_6_text'		=> isset($anggota_pr[$id][$no_anggota]['kesehatan_6_g_6_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_6_g_6_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_6_g_6_text'] : "Tidak",
	'kesehatan_6_g_7_text'		=> isset($anggota_pr[$id][$no_anggota]['kesehatan_6_g_7_text']) && $anggota_pr[$id][$no_anggota]['kesehatan_6_g_7_text']!=""? $anggota_pr[$id][$no_anggota]['kesehatan_6_g_7_text'] : "Tidak",
);
		}
		$kode='P'.$this->session->userdata('puskesmas');
		$kd_prov = $this->morganisasi_model->get_nama('value','cl_province','code',substr($kode, 1,2));
