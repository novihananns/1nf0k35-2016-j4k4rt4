...
<script type="text/javascript">
    $(document).ready(function(){
        $('#btn_back,#btn_back2').click(function(){
            window.location.href="<?php echo base_url()?>mst/puskesmas";
        });
        ...
        $('#btn_updateProfile').click(function(){
          ...
          $.ajax({ 
            type: "POST",
            url: "<?php echo base_url()?>mst/puskesmas/update_puskes/{code}",
...
<div class="row" style="background:#FAFAFA">
  <div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#tab_1" data-toggle="tab">Puskesmas</a></li>      
    </ul>
      ...
      <div class="tab-pane active" id="tab_1">    
        ...
        <div class="col-md-6 col-md-offset-1">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" placeholder="No.Tlp" name="tlp" value="<?php 
