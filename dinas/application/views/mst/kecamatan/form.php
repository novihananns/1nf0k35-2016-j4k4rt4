...
<script type="text/javascript">
    $(document).ready(function(){
        $('#btn_back,#btn_back2').click(function(){
            window.location.href="<?php echo base_url()?>mst/kecamatan";
        });

        $('#btn_updateKecamatan').click(function(){
          $('#notification').hide();
          $.ajax({ 
            type: "POST",
            url: "<?php echo base_url()?>mst/kecamatan/update_kecamatan/{code}",
            data: $('#updateKecamatan').serialize(),
...
<div class="row" style="background:#FAFAFA">
  <div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#tab_1" data-toggle="tab">Kecamatan</a></li>      
    </ul>
    <div class="tab-content">
      <div class="tab-pane active" id="tab_1">    
        <!-- <form action="<?php echo base_url()?>disbun/profile_doupdate" method="post"> -->
        <form name="updateKecamatan" id="updateKecamatan">
        <div class="row">
        <div class="col-md-6 col-md-offset-1">
            ...
            <br>
              ...
              <input type="text" class="form-control" placeholder="Nama" name="nama" value="<?php 
          ...
          <div class="col-xs-2 col-md-offset-1">
            <button type="button" id="btn_updateKecamatan" class="btn btn-warning btn-block btn-flat">Simpan</button>
