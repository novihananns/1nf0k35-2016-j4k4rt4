...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody><tr>
    <td>
      ...
      <tr>
        <td class="username-bg">Suku Dinas</td>
        <td class="textfield-bg"><input placeholder=" Dinas" name="dinas" size="20" class="input ac_input" autocomplete="off" type="text" readonly>
...
<script>
    $(document).ready(function(){
      ...
      $("input[name=dinas]").val('JAKARTA TIMUR');
      $("input[name=dinas]").attr('readonly','true');
      $("input[name=dinas]").css('background','#7ddb49');
