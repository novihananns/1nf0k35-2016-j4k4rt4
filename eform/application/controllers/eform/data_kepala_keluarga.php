...
$data_tabel[] = array(
	...
	'kes_batu'		=> ((isset($anggota_pr[$id][$no_anggota]['kesehatan_2_g_1_radio'])) ? ($anggota_pr[$id][$no_anggota]['kesehatan_2_g_1_radio']==0? "Ya" : ($anggota_pr[$id][$no_anggota]['kesehatan_2_g_2_radio']==1? "Tidak" : "x")):'x'),
