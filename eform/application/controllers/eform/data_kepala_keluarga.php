...
$data_tabel[] = array(
	...
	'nourutkel'		=> $act['nourutkel'] 	!="" ? $act['nourutkel'] : "-",
	'nik'			=> $act['nik'] 			!="" ? $act['nik'] : "-",
	...
	'putus_sekolah'	=> ((isset($anggota_pr[$id][$no_anggota]['kesehatan_0_g_3_radio'])) ? ($anggota_pr[$id][$no_anggota]['kesehatan_0_g_3_radio']==0? "Ya" : ($anggota_pr[$id][$no_anggota]['kesehatan_0_g_3_radio']==1? "Tidak" : "x")):'x'),
	'paud_pernah'	=> ((isset($anggota_pr[$id][$no_anggota]['kesehatan_0_g_4_radio'])) ? ($anggota_pr[$id][$no_anggota]['kesehatan_0_g_4_radio']==0? "Ya" : ($anggota_pr[$id][$no_anggota]['kesehatan_0_g_4_radio']==1? "Tidak" : "x")):'x'),
	'kelompok_bljr'	=> ((isset($anggota_pr[$id][$no_anggota]['kesehatan_0_g_5_radio'])) ? ($anggota_pr[$id][$no_anggota]['kesehatan_0_g_5_radio']==0? "Ya" : ($anggota_pr[$id][$no_anggota]['kesehatan_0_g_5_radio']==1? "Tidak" : "x")):'x'),
	...
	'kb_hidup_l'		=> isset($kb[$id]['berencana_II_2_laki_hidup']) && $kb[$id]['berencana_II_2_laki_hidup']!=""? $kb[$id]['berencana_II_2_laki_hidup'] : "x",
	'kb_hidup_p'		=> isset($kb[$id]['berencana_II_2_perempuan_hidup']) && $kb[$id]['berencana_II_2_perempuan_hidup']!=""? $kb[$id]['berencana_II_2_perempuan_hidup'] : "x",
	'ikut_sertakb'		=> ((isset($kb[$id]['berencana_II_3_kb_radio'])) ? ($kb[$id]['berencana_II_3_kb_radio']==0? "Sedang" : ($kb[$id]['berencana_II_3_kb_radio']==1? "Pernah" : ($kb[$id]['berencana_II_3_kb_radio']==2? "Tidak Pernah" : "x"))):'x'),
	'metode_kb'			=> ((isset($kb[$id]['berencana_II_4_kontrasepsi_sepsi'])) ? ($kb[$id]['berencana_II_4_kontrasepsi_sepsi']==0? "IUD" : ($kb[$id]['berencana_II_4_kontrasepsi_sepsi']==1? "MOW" : ($kb[$id]['berencana_II_4_kontrasepsi_sepsi']==2? "MOP" : ($kb[$id]['berencana_II_4_kontrasepsi_sepsi']==6? "Implan" : ($kb[$id]['berencana_II_4_kontrasepsi_sepsi']==3? "Suntik" : ($kb[$id]['berencana_II_4_kontrasepsi_sepsi']==7? "Pil" : ($kb[$id]['berencana_II_4_kontrasepsi_sepsi']==5? "Pil" : ($kb[$id]['berencana_II_4_kontrasepsi_sepsi']==8? "Tradisional" : "x")))))))):'x'),
	'lama_kb'			=> (isset($kb[$id]['berencana_II_5_tahun']) && $kb[$id]['berencana_II_5_tahun']!=""? $kb[$id]['berencana_II_5_tahun'].' Tahun' : "").' '.(isset($kb[$id]['berencana_II_5_bulan']) && $kb[$id]['berencana_II_5_bulan']!=""? $kb[$id]['berencana_II_5_bulan'].' Bulan' : "").' '.(((!isset($kb[$id]['berencana_II_5_tahun'])) && (!isset($kb[$id]['berencana_II_5_bulan'])) ) ? 'x' : ""),
	'ingin_anak'		=> ((isset($kb[$id]['berencana_II_6_anak_radio'])) ? ($kb[$id]['berencana_II_6_anak_radio']==1 || $kb[$id]['berencana_II_6_anak_radio']==0 ? "Ya" : ($kb[$id]['berencana_II_6_anak_radio']==2? "Tidak" : "x")):'x'),
	...
	'tempat_kb'			=> ((isset($kb[$id]['berencana_II_8_pelayanan_radkb'])) ? ($kb[$id]['berencana_II_8_pelayanan_radkb']==0? "RSUP/RSUD" : ($kb[$id]['berencana_II_8_pelayanan_radkb']==1? "RSU TNI" : ($kb[$id]['berencana_II_8_pelayanan_radkb']==2? "RS Porli" : ($kb[$id]['berencana_II_8_pelayanan_radkb']==3? "RS Swasta" : ($kb[$id]['berencana_II_8_pelayanan_radkb']==4? "Klinik Umum" : ($kb[$id]['berencana_II_8_pelayanan_radkb']==5? "Puskesmas" : ($kb[$id]['berencana_II_8_pelayanan_radkb']==6? "Klinik Pratama" : ($kb[$id]['berencana_II_8_pelayanan_radkb']==7? "Praktek Dokter" : ($kb[$id]['berencana_II_8_pelayanan_radkb']== 8 ? "RS Prtama" : ($kb[$id]['berencana_II_8_pelayanan_radkb']==9? "Pustu/Pusling/Bides" : ($kb[$id]['berencana_II_8_pelayanan_radkb']==10? "Poskesdes/Polindes" : ($kb[$id]['berencana_II_8_pelayanan_radkb']==11? "Praktek Bidan" : ($kb[$id]['berencana_II_8_pelayanan_radkb']==12? "Pelayanan Bergerak" : ($kb[$id]['berencana_II_8_pelayanan_radkb']==13? "Lainnya" : "x")))))))))))))):'x'),
	'beli_pakain'		=> ((isset($pembangunan[$id]['pembangunan_III_1_radio'])) ? ($pembangunan[$id]['pembangunan_III_1_radio']==0? "Ya" : (($pembangunan[$id]['pembangunan_III_1_radio']==1 ||$pembangunan[$id]['pembangunan_III_1_radio']==2) ? "Tidak" : "x")):'x'),
	'makansehari2x'		=> ((isset($pembangunan[$id]['pembangunan_III_2_radio'])) ? ($pembangunan[$id]['pembangunan_III_2_radio']==0? "Ya" : (($pembangunan[$id]['pembangunan_III_2_radio']==1 ||$pembangunan[$id]['pembangunan_III_2_radio']==2)? "Tidak" : "x")):'x'),
	...
	'pem_atap_terluas'	=> (isset($pembangunan[$id]['pembangunan_III_1_19_cebo4']) && $pembangunan[$id]['pembangunan_III_1_19_cebo4']==0? "Daun;" : "").' '.(isset($pembangunan[$id]['pembangunan_III_2_19_cebo4']) && $pembangunan[$id]['pembangunan_III_2_19_cebo4']==1? "Seng/Asbes;" : "").' '.(isset($pembangunan[$id]['pembangunan_III_3_19_cebo4']) && $pembangunan[$id]['pembangunan_III_3_19_cebo4']==2? "Genteng;" : "").' '.(isset($pembangunan[$id]['pembangunan_III_4_19_cebo4']) && $pembangunan[$id]['pembangunan_III_4_19_cebo4']==3? "Lainnya;" : "").' '.((!isset($pembangunan[$id]['pembangunan_III_1_19_cebo4']) && !isset($pembangunan[$id]['pembangunan_III_2_19_cebo4']) && !isset($pembangunan[$id]['pembangunan_III_3_19_cebo4']) && !isset($pembangunan[$id]['pembangunan_III_4_19_cebo4']))? 'x':''),
	'pem_dinding_terluas'=> isset($pembangunan[$id]['pembangunan_III_1_20_cebo4']) && $pembangunan[$id]['pembangunan_III_1_20_cebo4']==0? "Tembok;" : "".' '.(isset($pembangunan[$id]['pembangunan_III_2_20_cebo4']) && $pembangunan[$id]['pembangunan_III_2_20_cebo4']==1? "Kayu/Seng;" : "").' '.(isset($pembangunan[$id]['pembangunan_III_3_20_cebo4']) && $pembangunan[$id]['pembangunan_III_3_20_cebo4']==2? "Bambu;" : "").' '.(isset($pembangunan[$id]['pembangunan_III_4_20_cebo4']) && $pembangunan[$id]['pembangunan_III_4_20_cebo4']==3? "Lainnya;" : "").' '.((!isset($pembangunan[$id]['pembangunan_III_1_20_cebo4']) && !isset($pembangunan[$id]['pembangunan_III_2_20_cebo4']) && !isset($pembangunan[$id]['pembangunan_III_3_20_cebo4']) && !isset($pembangunan[$id]['pembangunan_III_4_20_cebo4'])) ? 'x':''),
	'pem_lantai_terluas'	=> (isset($pembangunan[$id]['pembangunan_III_1_21_cebo4']) && $pembangunan[$id]['pembangunan_III_1_21_cebo4']==0? "Ubin/Kramik/Marmer;" : "").' '.(isset($pembangunan[$id]['pembangunan_III_2_21_cebo4']) && $pembangunan[$id]['pembangunan_III_2_21_cebo4']==1? "Semen/Papan;" : "").' '.(isset($pembangunan[$id]['pembangunan_III_3_21_cebo4']) && $pembangunan[$id]['pembangunan_III_3_21_cebo4']==2? "Tanah;" : "").' '.(isset($pembangunan[$id]['pembangunan_III_4_21_cebo4']) && $pembangunan[$id]['pembangunan_III_4_21_cebo4']==3? "Lainnya;" : "").' '.((!isset($pembangunan[$id]['pembangunan_III_1_21_cebo4']) && !isset($pembangunan[$id]['pembangunan_III_2_21_cebo4']) && !isset($pembangunan[$id]['pembangunan_III_3_21_cebo4']) && !isset($pembangunan[$id]['pembangunan_III_4_21_cebo4'])) ? 'x' :''),
	...
	'pem_bab_fasilitas'	=> ((isset($pembangunan[$id]['pembangunan_III_25_radi4'])) ? ($pembangunan[$id]['pembangunan_III_25_radi4']==0? "Jamban Sendiri" : ($pembangunan[$id]['pembangunan_III_25_radi4']==1? "Jamban Bersama" : ($pembangunan[$id]['pembangunan_III_25_radi4']==2? "Jamban Umum" : ($pembangunan[$id]['pembangunan_III_25_radi4']==3? "Lainnya" : "x")))):'x'),
	'pem_rumah_milik'	=> (isset($pembangunan[$id]['pembangunan_III_26_1_cebo4']) && $pembangunan[$id]['pembangunan_III_26_1_cebo4']==0? "Sendiri" : "").' '.(isset($pembangunan[$id]['pembangunan_III_26_2_cebo4']) && $pembangunan[$id]['pembangunan_III_26_2_cebo4']==1? "Sewa/Kontrak;" : "").' '.(isset($pembangunan[$id]['pembangunan_III_26_3_cebo4']) && $pembangunan[$id]['pembangunan_III_26_3_cebo4']==2? "Menumpang" : "").' '.(isset($pembangunan[$id]['pembangunan_III_26_4_cebo4']) && $pembangunan[$id]['pembangunan_III_26_4_cebo4']==3? ":Lainnya" : "").' '.((!isset($pembangunan[$id]['pembangunan_III_26_1_cebo4']) && !isset($pembangunan[$id]['pembangunan_III_26_2_cebo4']) && !isset($pembangunan[$id]['pembangunan_III_26_3_cebo4']) && !isset($pembangunan[$id]['pembangunan_III_26_4_cebo4'])) ? 'x' :''),
	...
	'kes_rokoksebulan'			=> ((isset($anggota_pr[$id][$no_anggota]['kesehatan_1_g_1_radi5'])) ? (($anggota_pr[$id][$no_anggota]['kesehatan_1_g_1_radi5']==0 || $anggota_pr[$id][$no_anggota]['kesehatan_1_g_1_radi5']==1)? "Ya" : (($anggota_pr[$id][$no_anggota]['kesehatan_1_g_1_radi5']==2 || $anggota_pr[$id][$no_anggota]['kesehatan_1_g_1_radi5']==3 || $anggota_pr[$id][$no_anggota]['kesehatan_1_g_1_radi5']==4) ? "Tidak" : "x")):'x'),
	...
	'darting_obat'				=> ((isset($anggota_pr[$id][$no_anggota]['kesehatan_4_g_3_hp_radio'])) ? ($anggota_pr[$id][$no_anggota]['kesehatan_4_g_3_hp_radio']==0? "Ya" : ($anggota_pr[$id][$no_anggota]['kesehatan_4_g_3_hp_radio']==1? "Tidak" : "x")):'x'),
	...
	'kesehatan_konjungtiva'		=> ((isset($anggota_pr[$id][$no_anggota]['kesehatan_6_g_5_radio'])) ? ($anggota_pr[$id][$no_anggota]['kesehatan_6_g_5_radio']==0? "Pucat" : ($anggota_pr[$id][$no_anggota]['kesehatan_6_g_5_radio']==1? "Normal" : "x")):'x'),
