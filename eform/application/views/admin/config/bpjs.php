        ...
        <!-- form start -->
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="serverbpjs" placeholder="Server" value="<?php 
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="usernamebpjs" placeholder="Username" value="<?php 
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" name="passwordbpjs" placeholder="Password" value="<?php 
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="considbpjs" placeholder="Cons ID" value="<?php 
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="keybpjs" placeholder="Secret Key" value="<?php 
          ...
          <div class="box-footer">
            <button type="button" id="btn-adds" class="btn btn-primary">Submit</button>
